...
const I18N = {
  ...
  fil: {
    ...
    navMarket: "Market",
    cart: "Cart",
    heroTitle: "Ang magandang damit ay karapat-dapat na makilala ang susunod na tao.",
    heroBody: "Isang curated second-hand clothing market na may malinaw na laki, presyo, at kondisyon ng damit. Ang mga customer ay maaaring mag-browse, magdagdag sa paboritong listahan, at maghanda ng inquiry list.",
    startShopping: "Magsimula ng pamimili",
    newDrop: "In stock",
    averagePrice: "Avg. price",
    marketPosition: "Market",
    marketValue: "Pre-loved",
  ...
  id: {
    code: "ID",
    htmlLang: "id",
    brandSub: "Pasar pakaian bekas pilihan",
    navStock: "Stok",
    navMarket: "Pasar",
    cart: "Keranjang",
    heroTitle: "Pakaian berkualitas layak bertemu dengan pemilik berikutnya.",
    heroBody: "Pasar pakaian bekas pilihan dengan ukuran, harga, dan kondisi yang jelas. Pelanggan dapat menjelajahi, menambahkan ke keranjang favorit, dan menyiapkan daftar pertanyaan.",
    startShopping: "Mulai berbelanja",
    newDrop: "Tersedia",
    averagePrice: "Harga rata-rata",
    marketPosition: "Pasar",
    marketValue: "Pre-loved",
    filters: "Filter",
    reset: "Atur Ulang",
    searchProducts: "Cari produk",
    searchPlaceholder: "Gaun, atasan, denim...",
    category: "Kategori",
    all: "Semua",
    tops: "Atasan",
    jackets: "Jaket",
    ...
    ready: "SIAP DIKIRIM",
    catalogTitle: "Stok terpilih",
    items: "item",
    item: "item",
    syncing: "Menyinkronkan inventori produk...",
    synced: "Inventori disinkronkan",
    updated: "diperbarui",
    fallback: "Saat ini menggunakan produk bawaan; halaman ini akan mencoba menyinkronkan lagi pada waktu berikutnya.",
    noMatchTitle: "Tidak ada pakaian yang cocok",
    noMatchBody: "Coba ukuran, kategori, atau anggaran yang berbeda.",
    liveUnsold: "Pre-loved",
    add: "Tambah",
    emptyCartTitle: "Keranjang belanja Anda kosong",
    emptyCartBody: "Tambahkan pakaian yang Anda sukai, lalu kirim permintaan checkout bersama.",
    notSelected: "Belum ada item",
    subtotal: "Subtotal",
    checkout: "Checkout",
    checkoutTitle: "Informasi penerima",
    recipientName: "Nama penerima",
    recipientPhone: "Nomor ponsel",
    ...
    number: "No.",
    room: "Kamar",
    shippingStoreBrand: "Toko pengambilan",
    chooseStoreBrand: "Pilih toko",
    storeCity: "Kota",
    storeDistrict: "Kecamatan",
    storeRoad: "Jalan",
    storeOption: "Toko terpilih",
    enterRoadFirst: "Masukkan jalan terlebih dahulu",
    recipientNote: "Catatan",
    recipientNamePlaceholder: "Masukkan nama penerima",
    recipientPhonePlaceholder: "Masukkan nomor ponsel",
    recipientAddressPlaceholder: "Masukkan alamat pengiriman",
    recipientNotePlaceholder: "Contoh: waktu pengiriman, konfirmasi ukuran, dll.",
    backToCart: "Kembali ke keranjang",
    backToInfo: "Kembali ke halaman sebelumnya",
    confirmInfo: "Konfirmasi info",
    closeCheckout: "Tutup checkout",
    remove: "Hapus",
    added: "ditambahkan ke keranjang",
    addFirst: "Silakan tambahkan item terlebih dahulu",
    ...
    closeDetail: "Tutup detail produk",
  ...
  vi: {
    code: "VI",
    htmlLang: "vi",
    brandSub: "Thị trường quần áo cũ được lựa chọn",
    navStock: "Hàng có sẵn",
    navMarket: "Thị trường",
    cart: "Giỏ hàng",
    heroTitle: "Quần áo tốt xứng đáng gặp được người chủ sở hữu tiếp theo.",
    heroBody: "Thị trường quần áo cũ được lựa chọn với kích cỡ, giá cả và tình trạng rõ ràng. Khách hàng có thể duyệt, thêm vào giỏ hàng ưa thích và chuẩn bị danh sách yêu cầu.",
    startShopping: "Bắt đầu mua sắm",
    newDrop: "Có sẵn",
    averagePrice: "Giá trung bình",
    marketPosition: "Thị trường",
    marketValue: "Pre-loved",
    filters: "Bộ lọc",
    reset: "Đặt lại",
    ...
    ready: "SẴN GỬI",
    catalogTitle: "Kho hàng được lựa chọn",
    items: "mặt hàng",
    item: "mặt hàng",
    syncing: "Đang đồng bộ hóa kho hàng sản phẩm...",
    synced: "Kho hàng đã đồng bộ hóa",
    updated: "đã cập nhật",
    fallback: "Hiện đang sử dụng sản phẩm tích hợp; trang này sẽ cố gắng đồng bộ hóa lại vào lần tới.",
    noMatchTitle: "Không có quần áo phù hợp",
    noMatchBody: "Hãy thử một kích cỡ, danh mục hoặc ngân sách khác.",
    liveUnsold: "Pre-loved",
    add: "Thêm",
    emptyCartTitle: "Giỏ hàng của bạn trống",
    emptyCartBody: "Thêm quần áo bạn thích, sau đó gửi yêu cầu thanh toán cùng nhau.",
    notSelected: "Chưa có mặt hàng",
    subtotal: "Tổng phụ",
    checkout: "Thanh toán",
    checkoutTitle: "Thông tin người nhận",
    recipientName: "Tên người nhận",
    recipientPhone: "Số điện thoại di động",
    ...
    number: "Số",
    room: "Phòng",
    shippingStoreBrand: "Cửa hàng nhận",
    chooseStoreBrand: "Chọn cửa hàng",
    storeCity: "Thành phố",
    storeDistrict: "Quận",
    storeRoad: "Đường / Phố",
    storeOption: "Cửa hàng được chọn",
    enterRoadFirst: "Nhập đường / phố trước",
    recipientNote: "Ghi chú",
    recipientNamePlaceholder: "Nhập tên người nhận",
    recipientPhonePlaceholder: "Nhập số điện thoại di động",
    recipientAddressPlaceholder: "Nhập địa chỉ giao hàng",
    recipientNotePlaceholder: "Ví dụ: thời gian giao hàng, xác nhận kích cỡ, v.v.",
    backToCart: "Quay lại giỏ hàng",
    backToInfo: "Quay lại trang trước",
    confirmInfo: "Xác nhận thông tin",
    closeCheckout: "Đóng thanh toán",
    remove: "Xóa",
    added: "đã thêm vào giỏ hàng",
    addFirst: "Vui lòng thêm một mặt hàng trước",
    inquiryReady: "Danh sách yêu cầu sẵn sàng",
...
function renderStoreOptions() {
  ...
  storeOption.placeholder = `請輸入 Google Maps 上選到的${prefix}門市名稱`;
}
